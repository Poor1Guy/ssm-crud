            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <%--部门提交部门id即可--%>
                            <select class="form-control" name="dId" id="dept_add_selsect">
                            </select>
                        </div>
                    </div>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <h1 align="justify">SSM-CRUD-FOR-LYF</h1>
        </div>
    </div>
    <%--按钮--%>
    <div class="row">
    ...
    <div class="row">
        ...
        <script type="text/javascript">
            ...
            function validate_add_form(){
                ...
                var regName = /(^[a-zA-Z0-9_-]{3,16}$)|(^[\u2E80-\u9FFF]{1,5})/;
                if(!regName.test(empName)){
                    //alert("用户名可以是2-5位中文或者6-16位英文和数字的组合");
                    show_validate_msg("#empName_add_input", "error", "用户名可以是1-5位中文或者3-16位英文和数字的组合");
                    return false;
                }else{
                ...
                $.ajax({
                    ...
                    success:function (result) {
                        ...
                        if (result.code == 100){
                            ...
                            //1、关闭模态框
                            $("#empModal").modal('hide');
                            //2、来到最后一页，显示保存数据,发送ajax请求到最后一页
                            to_page(totalRecord);
                        }else {
                            //显示失败信息
                            //console.log(result);
                            //有哪个字段的错误信息就显示哪个字段的信息
            ...
            //点击全部删除，就批量删除emp_delete_all_btn
